...
public class Day08Test extends AbstractTest {
    ...
    @BeforeAll
    static void setUp() {
        INPUT_PATH = "year2023/Day08_Input.txt";
        SAMPLE_INPUT_PATH = "year2023/Day08_SampleInput.txt";
    }
    ...
    static Stream<Arguments> inputDataSource() {
        ...
        return Stream.of(
            Arguments.of(Solution.PART_NUMBER.ONE, sampleInputLines, 6),
            Arguments.of(Solution.PART_NUMBER.ONE, inputLines, 15517),

//            Arguments.of(Solution.PART_NUMBER.TWO, sampleInputLines, 6),
            Arguments.of(Solution.PART_NUMBER.TWO, inputLines, 14935034899483L)
        );
    }
}

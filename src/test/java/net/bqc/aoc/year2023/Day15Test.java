...
public class Day15Test extends AbstractTest {
    ...
    static Stream<Arguments> inputDataSource() {
        ...
        return Stream.of(
            Arguments.of(Solution.Part.ONE, sampleInputLines, 1320),
            Arguments.of(Solution.Part.ONE, inputLines, 511498),
            
            Arguments.of(Solution.Part.TWO, sampleInputLines, 145),
            Arguments.of(Solution.Part.TWO, inputLines, 284674)
        );
    }
}

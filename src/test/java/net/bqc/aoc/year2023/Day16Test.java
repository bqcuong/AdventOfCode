...
public class Day16Test extends AbstractTest {
    ...
    static Stream<Arguments> inputDataSource() {
        ...
        return Stream.of(
            Arguments.of(Solution.PART_NUMBER.ONE, sampleInputLines, 46),
            Arguments.of(Solution.PART_NUMBER.ONE, inputLines, 8249),
            
            Arguments.of(Solution.PART_NUMBER.TWO, sampleInputLines, 51),
            Arguments.of(Solution.PART_NUMBER.TWO, inputLines, 8444)
        );
    }
}

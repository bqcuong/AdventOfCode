...
public class Day10Test extends AbstractTest {
    ...
    static Stream<Arguments> inputDataSource() {
        ...
        return Stream.of(
            Arguments.of(Solution.PART_NUMBER.ONE, sampleInputLines, 8),
            Arguments.of(Solution.PART_NUMBER.ONE, inputLines, 6812),

            Arguments.of(Solution.PART_NUMBER.TWO, sampleInputLines, 1),
            Arguments.of(Solution.PART_NUMBER.TWO, inputLines, 527)
        );
    }
}

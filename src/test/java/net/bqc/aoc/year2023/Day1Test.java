...
public class Day1Test extends AbstractTest {
    ...
    @BeforeAll
    static void setUp() {
        INPUT_PATH = "year2023/Day1_Input.txt";
    }
    ...
    @ParameterizedTest
    @MethodSource("calibrationSampleDataSource")
    ...
    @MethodSource("calibrationDataSource")
    static Stream<Arguments> calibrationSampleDataSource() {
        return Stream.of(

...
public class Day04Test extends AbstractTest {
    ...
    static Stream<Arguments> inputDataSource() {
        ...
        return Stream.of(
            Arguments.of(Solution.Part.ONE, sampleInputLines, 18),
            Arguments.of(Solution.Part.ONE, inputLines, 2496),
            
            Arguments.of(Solution.Part.TWO, sampleInputLines, 9),
            Arguments.of(Solution.Part.TWO, inputLines, 1967)
        );
    }
}

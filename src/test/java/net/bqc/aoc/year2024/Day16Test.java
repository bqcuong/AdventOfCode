...
public class Day16Test extends AbstractTest {
    ...
    @BeforeAll
    static void setUp() {
        INPUT_PATH = "year2024/Day16_Input.txt";
        SAMPLE_INPUT_PATH = "year2024/Day16_SampleInput.txt";
    }
    ...
    static Stream<Arguments> inputDataSource() {
        ...
        return Stream.of(
            Arguments.of(Solution.Part.ONE, sampleInputLines, 7036),
            Arguments.of(Solution.Part.ONE, inputLines, 79404),
            
            Arguments.of(Solution.Part.TWO, sampleInputLines, 45),
            Arguments.of(Solution.Part.TWO, inputLines, 451)
        );
    }
}

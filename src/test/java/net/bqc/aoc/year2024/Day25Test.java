...
public class Day25Test extends AbstractTest {
    ...
    @BeforeAll
    static void setUp() {
        INPUT_PATH = "year2024/Day25_Input.txt";
        SAMPLE_INPUT_PATH = "year2024/Day25_SampleInput.txt";
    }
    ...
    static Stream<Arguments> inputDataSource() {
        ...
        return Stream.of(
            Arguments.of(Solution.Part.ONE, sampleInputLines, 3),
            Arguments.of(Solution.Part.ONE, inputLines, 3291)
        );
    }
}
